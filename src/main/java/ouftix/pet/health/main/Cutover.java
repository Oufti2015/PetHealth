...
import ouftix.pet.health.main.ouftx.pet.health.model.*;
...
public class Cutover {
    ...
    public static void main(String[] args) {
        ...
        Pet edgar = Pet.builder().id("1").name("Edgar").petType(Pet.PetType.DOG).birthDay(LocalDate.of(2004, Month.DECEMBER, 27)).deathDay(LocalDate.of(2016, Month.SEPTEMBER, 4)).build();
        Pet hyuma = Pet.builder().id("2").name("Hyuma").petType(Pet.PetType.DOG).birthDay(LocalDate.of(2008, Month.DECEMBER, 8)).build();
        Pet canelle = Pet.builder().id("3").name("Canelle").petType(Pet.PetType.CAT).birthDay(LocalDate.of(2011, Month.MAY, 5)).build();
        Pet muse = Pet.builder().id("4").name("Muse").officialName("Alba'Eyes Muse").petType(Pet.PetType.DOG).birthDay(LocalDate.of(2013, Month.MAY, 7)).build();
